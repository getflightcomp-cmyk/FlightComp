      ...
      <div className="legal-pg">
        <div className="legal-inner">
          ...
          <section className="legal-section">
            ...
            <p>FlightComp will offer a managed claims service on a no-win, no-fee basis. If we do not recover compensation on your behalf, you owe nothing. If we do, our fee is 20% of the compensation recovered. Full terms for this service will be published before it launches.</p>
          </section>
