...
export const AIRLINE_CONTACTS = {
  ...
  LH: {
    name: 'Lufthansa',
    claimsEmail: null, // was customer.relations@lufthansa.com — Apr 16 auto-reply: email not saved or forwarded; use web form
    claimsFormUrl: 'https://www.lufthansa.com/mk/en/compensation-in-the-event-of-flight-irregularities',
  ...
  LG: {
    name: 'Luxair',
    claimsEmail: null, // was customer.relations@luxair.lu — Apr 16 auto-reply: email no longer processed; use contact form
    claimsFormUrl: 'https://www.luxair.lu/contactform',
    mailingAddress: 'Luxair, Customer Relations, Aéroport de Luxembourg, L-2987 Luxembourg',
    webFormOnly: true,
  },
  DE: {
    name: 'Condor',
    claimsEmail: null, // was customer.relations@condor.com (general reservations); route to dedicated EU261 form instead
    claimsFormUrl: 'https://www.condor.com/eu/help-contact/contact/complaint-form-eu261.jsp',
...
export function getAirlineContact(input) {
  ...
  // 4. IATA prefix from flight number — 2 alphanumeric chars followed by digits
  //    [A-Z0-9] is required because some IATA codes contain digits (U2, W6, F8, 8P, 8Q, etc.)
  const iataM = stripped.match(/^([A-Z0-9]{2})\d/);
